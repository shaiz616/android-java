    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("paymentDet ", " pass");


                if(flatNum != "" && amount !="") {

                    pay = new Payment(flatNum, amount, month);
                    hasAppartment(pay);

                }else {
                    Log.w("err", "missing details");
    ...
    public void hasAppartment(Payment pay) {
        ...
        for (Tennant user : list) {
            if(user.getFlat_number() ==Integer.parseInt(pay.getApartment())) {
                ...
                Toast.makeText(main, "apartment number not found,//n Please change and try again", Toast.LENGTH_LONG).show();
            }
        }
    }
}